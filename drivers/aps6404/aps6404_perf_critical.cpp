...
namespace pimoroni {
    void APS6404::write_no_page_crossing(uint32_t addr, const uint32_t* data, uint32_t len_in_bytes) {
    ...
    void APS6404::write(uint32_t addr, const uint32_t* data, uint32_t len_in_bytes) {
